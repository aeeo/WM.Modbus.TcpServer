...
namespace WG3000.Modbus.TcpServer
{
    public class ConfigureAuth : IConfigureServices, IConfigureAppHost, IPostInitPlugin
    {
        ...
        public void AfterPluginsLoaded(IAppHost appHost)
        {
            ...
            void EnsureUser(string email, string name, IEnumerable<string> roles=null)
            {
            ...
            EnsureUser("employee@gmail.com", name:"User",   roles:new[]{ "User" });
            EnsureUser("accounts@gmail.com", name:"Admin", roles:new[]{ "Admin" });
        }
    }
}